<template>
    <div class="container">
        <el-form ref="taskForm" :model="task">
            ...
            <el-form-item>
                <el-button type="primary" @click="submitTask('groundWorkTaskForm')">Create</el-button>
                <el-button @click="resetForm('groundWorkTaskForm')">Reset</el-button>
            </el-form-item>
